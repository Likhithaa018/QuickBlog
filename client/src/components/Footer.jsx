...
const Footer = () => {
  return (
    //There are 4 colums. So, creating 4 divs.
    <div className='px-6 md:px-16 lg:px-24 xl:px-32 bg-primary/3'>
           ...
           <div>
            ...
            md:w-[45%] gap-5'>
                {footer_data.map((section, index)=>(
                    <div key={index}>
                        <h3 className='font-semiboldtext-base text-gray-900
        ...
        <p className='py-4 text-center text-sm md:text-base text-gray-500/80'>Copyright 2025 &copy; QuickBlog - All rights Reserved.</p>
    </div>
  )
}
